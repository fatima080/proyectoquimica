        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <img class="logo" src="{{ asset('images/logoquimica.png') }}" alt="Logo quimica">
                </div>
                <div class="flex justify-center">
                    <h1 class="mt-6 text-xl font-semibold custom-title">GESTOR DE PRODUCTOS QUIMICOS</h1>
                </div>
                <div class="mt-16">
                ...
                <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                    ...
                    <div class="text-center text-sm green-text sm:text-right sm:ml-0">
                        Authors: Isabel Pascual y Fatima El Baz
                    </div>
                </div>
            </div>
        </div>
